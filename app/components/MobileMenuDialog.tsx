...
export default function MobileMenuDialog({
  ...
  return (
    ...
    >
      <DialogBackdrop
        transition
        className="bg-black/15 fixed inset-0 transition-opacity duration-150 ease-linear data-[closed]:opacity-0"
      />
          ...
          <div className="h-full flex flex-col justify-between">
            <div className="space-y-14">
              <ul className="font-semibold space-y-4 text-base">
                <li>
                  <Link href="/add-tea-note">Add Note</Link>
                </li>
